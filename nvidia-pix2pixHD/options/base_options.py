...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_type', default=32, type=int,
        ...
        # for displays
        self.parser.add_argument('--display_winsize', type=int,
                                 default=512,  help='display window size')
        ...
        self.parser.add_argument('--feat_num', type=int, default=3,
                                 help='vector length for encoded features')
        ...
        self.parser.add_argument('--n_clusters', type=int, default=10,
                                 help='number of clusters for features')
